...
class RidgeRegressionModel:
    ...
    def fit(self, X, y, alpha=None):
        ...
        self.best_model = Ridge(alpha=alpha, random_state=42)
    ...
    def compare_with_linear(self, X, y):
        ...
        plt.bar(x + width/2, ridge_coefs, width, label=f'Ridge (α={self.best_alpha})', alpha=0.7)
